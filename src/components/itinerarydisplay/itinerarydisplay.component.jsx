...
const ItineraryDisplay = ({ itinerary, classname, history, match, show }) => {
  ...
  let communityrating = Number(
    (itinerary["communityratingtotal"] / itinerary["communitymembers"]).toFixed(
      2
    )
  );
  console.log(show);
  return (
    <Link to={"/" + itinerary["id"]}>
      <div className={classname}>
        ...
        <div
          className={show === null ? "no-title-container" : "title-container"}
        >
          <div className="itinerary-title">
            {itinerary["citylower"].toUpperCase() +
              ", " +
              itinerary["countrylower"].toUpperCase()}
          </div>
        </div>

        <div
          className={show === null ? "no-length-container" : "length-container"}
        >
        ...
        <div
          className={
            show === null ? "no-community-container" : "community-container"
          }
        >
